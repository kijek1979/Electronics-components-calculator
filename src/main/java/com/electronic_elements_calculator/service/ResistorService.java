package com.electronic_elements_calculator.service;


import com.electronic_elements_calculator.model.Resistor;
import com.electronic_elements_calculator.repository.ResistorRepository;
...
public class ResistorService extends ResistorRepository {
    ...
    public List<Resistor> showResistorList(){
        for (Object o: getResistorList()
                ) {
    ...
    public int resistanceOfTheResistor(Resistor resistor) {
        return ((strap1Value(resistor) * 10 +
                +strap2Value(resistor)) * multiplierValue(resistor));
    }

    public double toleranceOfTheResistor(Resistor resistor) {
        return (double) (((strap1Value(resistor) * 10 +
                +strap2Value(resistor)) * multiplierValue(resistor)) / (100.0D / toleranceValue(resistor)));
    }
